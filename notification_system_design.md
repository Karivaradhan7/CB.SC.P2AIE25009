...
The goal of this project was to design a notification service that can support:

- targeted notifications
- unread tracking
- real-time delivery
- large student broadcasts without overloading the database
...
Initially SSE looked simpler because notifications are mostly server-to-client events. But for a larger campus system with active users, WebSockets would scale better if bidirectional communication becomes necessary later.
...
Mapping table for delivery and read status.
...
4. Delivery services handle emails and push notifications separately
